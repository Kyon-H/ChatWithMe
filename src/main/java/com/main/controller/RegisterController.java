...
public class RegisterController {
	...
	@Autowired private UserImageService userImgService;
	...
	public Map<String,Object> doRegister(String userName,String userNickName,String userPassword){
		...
		if(userService.getUser(userName)==null){
			...
			UserImage userImage=new UserImage(userDetail);
			userImage.setUserImg("http://ulsxecrimg.oss-cn-beijing.aliyuncs.com/userheadimg/default/photo.jpg");
			userService.addUser(user);
			userImgService.addUserImage(userImage);
			result = "success";
		}
		else{
			result = "exist";
